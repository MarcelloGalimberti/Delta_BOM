...
st.title('ASC MTSV4 MTO Delta BOM rev.20231016')
...
AIR_SAP = codici_non_in_PLM.merge(df_SAP_descrizione,how='left',left_on='Articolo', right_on='Materiale')
AIR_SAP = AIR_SAP.drop(columns=['Materiale'])
...
AIR_SAP_sub = df_output_confronto_L.merge(df_SAP_descrizione,how='left',left_on='Articolo SAP', right_on='Materiale')
