...
df_xlsx = to_excel(df_confronto_lev2)


# In[89]:


st.download_button(label='Scarica il modulo per il registro delle azioni',
                                data=df_xlsx ,
                                file_name= 'Registro delle azioni livelli 2.xlsx')
